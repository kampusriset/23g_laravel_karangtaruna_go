        ...
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm text-gray-500 dark:text-gray-400">
                    {{ $this->getViewData()['currentDate']->format('d F Y') }}
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                    <div class="text-2xl font-bold text-blue-600 dark:text-blue-400">
                        {{ $this->getViewData()['agendaHariIni']->count() }}
                    </div>
                ...
                <div class="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border border-green-200 dark:border-green-800">
                    <div class="text-2xl font-bold text-green-600 dark:text-green-400">
                        {{ $this->getViewData()['agendaMingguIni']->count() }}
                    </div>
                ...
                <div class="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg border border-yellow-200 dark:border-yellow-800">
                    <div class="text-2xl font-bold text-yellow-600 dark:text-yellow-400">
                        {{ $this->getViewData()['agendaBulanIni']->count() }}
                    </div>
                ...
                <div class="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg border border-purple-200 dark:border-purple-800">
                    <div class="text-2xl font-bold text-purple-600 dark:text-purple-400">
                        {{ $this->getViewData()['agendaMendatang']->count() }}
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="space-y-3 max-h-64 overflow-y-auto">
                        @forelse($this->getViewData()['agendaHariIni'] as $agenda)
                        ...
                        @empty
                            <div class="p-4 text-center text-gray-500 dark:text-gray-400">
                                <x-heroicon-m-calendar-x class="w-8 h-8 mx-auto mb-2 opacity-50" />
                ...
                <div>
                    ...
                    <div class="space-y-3 max-h-64 overflow-y-auto">
                        @forelse($this->getViewData()['agendaMendatang'] as $agenda)
